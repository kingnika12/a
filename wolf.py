...
def main():
    ...
    port = input(stage(f"\033[38;5;208mPORT \033[35m[{white}press \033[38;5;45menter{white} to launch nukes all port\033[35m] \033[35m->\033[38;5;45m ", '?'))
    print()
    ...
    force = input(stage(f"\033[38;5;208mEvasion \033[35m[{white}press \033[38;5;45menter{white} for 2000\033[35m] \033[35m->\033[38;5;45m ", '?'))
    print()
    ...
    threads = input(stage(f"\033[38;5;208mThreads \033[35m[{white}press \033[38;5;45menter{white} for 100\033[35m] \033[35m->\033[38;5;45m ", '?'))
    print()
    ...
    try:
        ...
        brute.stop()
        print(stage(f"{orange}Stopped. {fluo2}{ip}{cport}{white} was Diddled With {fluo}{round(brute.total, 1)} {white}GB."))
    print('\n')
    sleep(1)
